...
for i in range(1000):
    ...
    time_record.append(sim.getTime())
    obs_A = sim.getObservation("A")
    A_record.append(obs_A)
    obs_B = sim.getObservation("B")
    B_record.append(obs_B)
    AB_record.append(sim.getObservation("AB"))

plt.plot(time_record,A_record,label = "A")
plt.plot(time_record,B_record,label = "B")
plt.plot(time_record,AB_record,label = "AB")
plt.xlabel("Time(ms)")
