...
ca_cyt01 = h.Vector().record(ca[cyt].nodes(dend(0.1))._ref_concentration)
...
es1 = ExternalSimulatorInterface(ca[cyt].nodes(dend(0.1)), kappa_file = "tests/caPump1.ka")
...
for vec in [ca_cyt01, ca_er01, ca_cyt09, ca_er09]:
